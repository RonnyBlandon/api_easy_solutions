...
class BusinessImage(Base):
    ...
    # Relación inversa
    business = relationship("Business", back_populates="business_images")
...
class Business(Base):
    ...
    business_images = relationship("BusinessImage", back_populates="business", cascade="all, delete-orphan")  # Relación con BusinessImage
    business_categories = relationship("Category", back_populates="business", cascade="all, delete-orphan")
